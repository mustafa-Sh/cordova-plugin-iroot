...
static const unsigned char P04[] = {0x88, 0xD4, 0xDE, 0xD4, 0xD3, 0xC2, 0xCA, 0x88, 0xDF, 0xC5, 0xCE, 0xC9, 0x88, 0xC1, 0xD5, 0xCE, 0xC3, 0xC6, 0x8A, 0xD4, 0xC2, 0xD5, 0xD1, 0xC2, 0xD5};
...
static const EncodedValue ARTIFACT_VALUES[]={{P01,sizeof(P01),0x55},{P02,sizeof(P02),0x44},{P03,sizeof(P03),0x4F},{P04,sizeof(P04),0xA7}};
